...
# Updating the model
# Since the graph shows a little improvements after 200 epochs, I'll update the model.fit()
# method to stop training when the validation score doesn't improve.
model = build_model()
